    ...
    <body>
        ...
        <div id="wrapper">
            <div id="contents" >
                ...
                <jsp:useBean class="modelo.cliente.Cliente" id="cliente" scope="session">
                        ...
                        <form class="formLogin" 
                            ...
                            <table>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <%@page import="servicios.GenerarNumeroCuenta"%>
                                        <%=GenerarNumeroCuenta.generarNumeroCuentaAuto("")%>
                                    </td>
                                </tr>
