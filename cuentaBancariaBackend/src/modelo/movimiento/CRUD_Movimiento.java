...
public enum CRUD_Movimiento {
    INSERTAR("INSERT INTO movimiento (id_movimiento, cuenta_num_cuenta,"
            + " monto, fecha, aplicado, movimientocol) "
            + "VALUES (?, ?, ?, ?, ?, ?); "),
    ...
    CONSULTAR("SELECT id_movimiento, cuenta_num_cuenta, monto, fecha, aplicado, movimientocol FROM movimiento"
            + " WHERE id_movimiento=?; "),
